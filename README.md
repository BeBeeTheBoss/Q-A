...
Open http://localhost:5000 in a browser. Survey responses are persisted in `data.json` in this project folder. For development with automatic server restarts, run `npm run dev`.
